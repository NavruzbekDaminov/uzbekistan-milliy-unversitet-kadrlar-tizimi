...
<center>
    <div class="backk" style="float: left; margin-left: 120px;">
        <button><a href="faculty_profile_by_academic_rank.php">Orqaga</a></button>
    </div>
    ...
    <div ng-app="myApp" ng-controller="myCtrl">
      ...
      <table>
        <tr>
          ...
          <td><input ng-model="firstname" placeholder="Ism" class="form-control" required=""></td>
        </tr>
        <tr>
          <td>Lavozimi :</td>
        ...
        <tr>
          ...
          <td><input ng-model="certified" placeholder="Ism" class="form-control" required=""></td>
        </tr>
        <tr>
          <td>Lavozimi :</td>
