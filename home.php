  ...
  <div class="row clearfix">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-indigo hover-expand-effect">
        ...
        <div class="content">
          <div class="text">Fakultetlar</div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-blue hover-expand-effect">
        ...
        <div class="content">
          <div class="text">Kafedralar</div>
          <div class="number count-to">81</div>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-purple hover-expand-effect">
        ...
        <div class="content">
          <div class="text">Bo'limlar soni</div>
          <div class="number count-to">24</div>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-indigo hover-expand-effect">
        ...
        <div class="content">
          <div class="text">DSc va Doktorlar</div>
          <div class="number count-to">27</div>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-blue hover-expand-effect">
        ...
        <div class="content">
          <div class="text">PHD va Fan nomzodlari</div>
          <div class="number count-to">27</div>
        </div>
      </div>
    </div>
