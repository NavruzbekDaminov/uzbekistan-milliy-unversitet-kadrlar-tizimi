                ...
                <div class="">
                    <div class = "panel panel-primary">
                        <div class = "panel-heading">
                            <button class = "btn btn-default" href="#" data-toggle="modal" data-target="#add_file" style = "float:right; width:150px;">Fayl yuklash</button>
                            <h4>SHAXSIY FILE</h4>
                        </div>
                    </div>
                    ...
                    <div id="print">
                        ...
                        <div class="card pull-right" style="width: 58%;">
                            <div class="per-files">
                                <div class = "panel panel-primary">
